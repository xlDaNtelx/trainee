...
var date = function date(value, allValues) {
  console.log(__WEBPACK_IMPORTED_MODULE_0_luxon__["DateTime"]); // const { day, month, year } = allValues;
  // if (day && month && year) {
  //   const validationDate = DateTime.fromObject({ day: day, month: month, year: year });
...
//# sourceMappingURL=5.b808757ddd767b844c8d.hot-update.js.map